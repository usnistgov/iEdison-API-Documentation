...
| conPatentReason | When submitting a continuation of a patent application, if the parent patent is absent, clarify why the parent application is not considered a subject invention. | Yes | String | 4000 | v1+ |
### Response Parameters
